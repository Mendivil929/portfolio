...
const PortfolioBox = (props: PortfolioBoxProps) => {
    ...
    return (
        <div className="p-4 border border-teal-50 rounded-xl">
            ...
            <div className="flex gap-5 mt-5 md:mt-2">
                <Link href={urlGithub} target="_blank" 
                    className="p-2 transition duration-150 rounded-lg bg-slate-500 hover:bg-slate-500/8"
                >
                    Github
                </Link>
                <Link href={urlDemo} target="_blank" 
                    className="p-2 transition duration-150 rounded-lg bg-secondary hover:bg-secondary/8"
                >
                    Demo
                </Link>
            </div>
